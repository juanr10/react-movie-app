        ...
        <nav className="flex items-center justify-between flex-wrap bg-teal-500 p-6">
            ...
            <div className={"w-full block flex-grow lg:flex lg:items-center lg:w-auto transition duration-500 ease-in-out " + (navbarOpen ? '' : 'hidden')}>
                <div className="text-md lg:flex-grow text-white">
                    <a href="/" className="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-purple-300 mx-8">
                        Populares
                    </a>
                    <a href="/" className="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-purple-300 mx-8">
                        Próximamente
                ...
                <div>
                    <a href="/" className="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-purple-200 hover:text-white hover:bg-purple-400 mt-4 mx-8 lg:mt-0">Download</a>
                </div>
            </div>
         </nav>
     );
